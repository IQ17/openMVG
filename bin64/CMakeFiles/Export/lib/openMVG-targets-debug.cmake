...
set_target_properties(jpeg PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/jpeg.lib"
  )
...
set_target_properties(png PROPERTIES
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/png.lib"
  )

list(APPEND _IMPORT_CHECK_TARGETS png )
list(APPEND _IMPORT_CHECK_FILES_FOR_png "${_IMPORT_PREFIX}/lib/png.lib" )

# Import target "tiff" for configuration "Debug"
set_property(TARGET tiff APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
set_target_properties(tiff PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_DEBUG "C;CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "zlib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/tiff.lib"
  )
...
# Import target "flann_cpp_s" for configuration "Debug"
set_property(TARGET flann_cpp_s APPEND PROPERTY IMPORTED_CONFIGURATIONS DEBUG)
...
set_target_properties(openMVG_features PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_features.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_features.dll"
  )
...
set_target_properties(openMVG_image PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_image.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "openMVG_numeric;png;zlib;jpeg;tiff"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_image.dll"
  )
...
set_target_properties(openMVG_lInftyComputerVision PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_lInftyComputerVision.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "lib_clp;lib_OsiClpSolver;lib_CoinUtils;lib_Osi"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_lInftyComputerVision.dll"
  )
...
set_target_properties(openMVG_matching PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_matching.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "flann_cpp_s"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_matching.dll"
  )
...
set_target_properties(openMVG_kvld PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_kvld.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_kvld.dll"
  )
...
set_target_properties(openMVG_matching_image_collection PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_matching_image_collection.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "openMVG_matching"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_matching_image_collection.dll"
  )
...
set_target_properties(openMVG_multiview PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_multiview.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_DEBUG "lemon;openMVG_numeric;ceres;cxsparse"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_multiview.dll"
  )
...
set_target_properties(openMVG_numeric PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_numeric.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_numeric.dll"
  )
...
set_target_properties(openMVG_system PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_system.lib"
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_system.dll"
  )
...
set_target_properties(openMVG_sfm PROPERTIES
  IMPORTED_IMPLIB_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_sfm.lib"
  ...
  IMPORTED_LOCATION_DEBUG "${_IMPORT_PREFIX}/lib/openMVG_sfm.dll"
  )
