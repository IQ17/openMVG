...
set_target_properties(stlplus PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/stlplus.lib"
  )
...
set_target_properties(cxsparse PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/cxsparse.lib"
  )
...
set_target_properties(ceres PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "cxsparse"
...
set_target_properties(easyexif PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/easyexif.lib"
  )
...
set_target_properties(openMVG_features PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_features.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_features.dll"
  )
...
set_target_properties(openMVG_image PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_image.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "openMVG_numeric;png;zlib;jpeg;tiff"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_image.dll"
  )
...
set_target_properties(openMVG_lInftyComputerVision PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_lInftyComputerVision.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "lib_clp;lib_OsiClpSolver;lib_CoinUtils;lib_Osi"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_lInftyComputerVision.dll"
  )
...
set_target_properties(openMVG_matching PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_matching.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "flann_cpp_s"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_matching.dll"
  )
...
set_target_properties(openMVG_kvld PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_kvld.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_kvld.dll"
  )
...
set_target_properties(openMVG_matching_image_collection PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_matching_image_collection.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "openMVG_matching"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_matching_image_collection.dll"
  )
...
set_target_properties(openMVG_multiview PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_multiview.lib"
  IMPORTED_LINK_INTERFACE_LIBRARIES_RELEASE "lemon;openMVG_numeric;ceres;cxsparse"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_multiview.dll"
  )
...
set_target_properties(openMVG_numeric PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_numeric.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_numeric.dll"
  )
...
set_target_properties(openMVG_system PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_system.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_system.dll"
  )
...
set_target_properties(openMVG_sfm PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_sfm.lib"
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/openMVG_sfm.dll"
  )
